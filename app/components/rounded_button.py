...
# source: https://stackoverflow.com/questions/42579927/how-to-make-a-rounded-button-tkinter

class RoundedButton(tk.Canvas):
    def __init__(self, master=None, text:str="", font=("Times", 30), radius=25, btnforeground="#000000", btnbackground="#ffffff", clicked=None, *args, **kwargs):
        super(RoundedButton, self).__init__(master, *args, **kwargs, borderwidth=0)
